...
from tests.common.samples import LIGHTNING_BOLT_MTGIO_CARD_DATA, LIGHTNING_BOLT_MTG_CARD_DATA


@pytest.mark.offline
def test_mtgcard_valid() -> None:
    card = MTGCard(**LIGHTNING_BOLT_MTG_CARD_DATA)
...
def test_mtgcard_from_mtgio_card() -> None:
    mtgio_card = MTGIOCard(**LIGHTNING_BOLT_MTGIO_CARD_DATA)
