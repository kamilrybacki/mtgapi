      ...
      "paths": {
        ...
        "/metrics": {
          "get": {
            ...
            "description": "Placeholder metrics endpoint.

Returns 501 until metrics collection (Prometheus / OTEL) is implemented.",
            "operationId": "metrics_placeholder_metrics_get",
            "responses": {
              "200": {
                "description": "Successful Response",
                "content": {
        ...
        "schemas": {
          ...
          "MTGCard": {
            "properties": {
              ...
              "aliases": {
                "items": {
                  "$ref": "#/components/schemas/MTGCardAlias"
                },
                "type": "array",
                "title": "Aliases",
              ...
              "rulings": {
                "items": {
                  "$ref": "#/components/schemas/MTGCardRuling"
                },
                "type": "array",
                "title": "Rulings",
              ...
              "mana_value": {
                "$ref": "#/components/schemas/ManaValue",
